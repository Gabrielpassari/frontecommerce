...
export default function Trending() {
  ...
  <div className="flex flex-col justify-between gap-5 md:flex-row">
    <div>
      ...
      <p className="GolosText mt-1 text-lg">
        Descubra os produtos mais populares de Caracteres
      </p>
    </div>

    <div>
      <button className="btn GolosText cursor-pointer rounded-md bg-black px-6 py-3 text-xl text-white transition-all duration-300">
        Ver tudo
      </button>
    </div>
  </div>
  ...
  <div className="trending-swiper mt-20">
    <Swiper
            ...
            modules={[Autoplay]}
            autoplay={{
              delay: 2500, //2500 = 2,5 segundos
              disableOnInteraction: false, //continua o autoplay mesmo se o usuário interagir com o slider
            }}
            breakpoints={{
          ...
          >
            {ProductData.slice(0, 12).map((item, index) => ( //slice 12 permite mostrar até 12 imagens
                ...
                <div className='product-card cursor-pointer'>
                  <div className='product-image overflow-hidden rounded-2xl'>
                    ...
                    <div className='absolute right-5 top-5 flex flex-col gap-2'>
                      <i 
                      onClick= {() => addToWishlist(item)} //quando clicar no coração, chama a função addToWishlist
